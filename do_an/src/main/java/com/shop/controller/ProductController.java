...
//        Optional<Product> product = productService.findProductById(id);
//        if (product != null) {
//            return new ModelAndView("/admin/product/delete", "products",product );
//        } else {
//            return new ModelAndView("/error");
//        }
//    }
...
//        return new ModelAndView("redirect:/admin/home/product");
//    }
    @GetMapping("/delete-product/{id}")
    ...
    @PostMapping("/delete-product")
    public ModelAndView DeleteCategory(@ModelAttribute ("products") Product product) {
