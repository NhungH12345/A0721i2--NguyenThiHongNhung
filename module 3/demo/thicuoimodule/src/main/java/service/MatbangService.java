...
public class MatbangService {
        ...
        private Connection getConnection() {
            ...
            try {
                ...
                connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/thi", "root", "12345");
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//
    ...
    public void delete(int id) {
        ...
        private Matbang getMatbang(ResultSet resultSet) throws SQLException {
            ...
            String ngay_bat_dau = resultSet.getString(6);
            String ngay_ket_thuc = resultSet.getString(6);
