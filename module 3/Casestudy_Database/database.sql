...
-- Hiển thị thông tin của tất cả nhân viên có trong hệ thống có tên bắt đầu là một trong các ký tự
 ...
 -- cách khác: bắt đầu bằng tên HKT, nhưng ko tính họ
...
count(dich_vu.chi_phi_thue + hop_dong_chi_tiet.so_luong * dich_vu_di_kem.gia) as tong_tien from loai_khach
inner join khach_hang on loai_khach.ma_loai_khach = khach_hang.ma_loai_khach 
inner join hop_dong on khach_hang.ma_khach_hang = hop_dong.ma_khach_hang
...
where loai_dich_vu.ten_loai_dich_vu like '%Villa' or loai_dich_vu.ten_loai_dich_vu like '%Room'
